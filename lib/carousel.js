...
var Carousel = _react2['default'].createClass({
  ...
  render: function render() {
    ...
    return _react2['default'].createElement(
      'div',
      { className: ['slider', this.props.className || ''].join(' '), style: (0, _objectAssign2['default'])(this.getSliderStyles(), this.props.style || {}) },
  ...
  goToSlide: function goToSlide(index, isSwipe) {
  ...
  nextSlide: function nextSlide() {
    var isSwipe = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
    ...
    if (this.props.wrapAround) {
      ...
      this.goToSlide(Math.min(this.state.currentSlide + this.state.slidesToScroll, childrenCount - slidesToShow), isSwipe);
    }
  },
